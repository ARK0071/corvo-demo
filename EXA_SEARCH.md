...
| Content | Full text |
**Project Description:** Grant search to help port authorities match with federal/state grants for funding
...
```json
{
  "mcpServers": {
    "exa": {
      "url": "https://mcp.exa.ai/mcp?exaApiKey=ac4326ed-a411-46dc-a2e2-d8c23cda7452"
    }
  }
}
```
...
```
https://mcp.exa.ai/mcp?exaApiKey=ac4326ed-a411-46dc-a2e2-d8c23cda7452&tools=web_search_exa,get_code_context_exa,people_search_exa
```

Enable all tools:
```
https://mcp.exa.ai/mcp?exaApiKey=ac4326ed-a411-46dc-a2e2-d8c23cda7452&tools=web_search_exa,web_search_advanced_exa,get_code_context_exa,crawling_exa,company_research_exa,people_search_exa,deep_researcher_start,deep_researcher_check
```

**Your API key:** `ac4326ed-a411-46dc-a2e2-d8c23cda7452`
